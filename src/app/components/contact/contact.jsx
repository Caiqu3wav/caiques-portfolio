...
export default function Contact() {
    return(
      <div className="bg-[#251c4c] flex flex-col w-full h-fit">
  ...
  <defs>
    <linearGradient id="gradient" gradientTransform="rotate(90)">
      <stop offset="10%"  stopColor="#4d0066" />
      <stop offset="90%" stopColor="#4d0066" />
    </linearGradient>
  </defs>
</Wave>
<div id="contact" className="flex items-center justify-center min-h-[400px] bg-gradient-to-b from-[#4d0066] to-[#e6ccff]">
<div className="hero-container relative bottom-[70px] pt-2 bg-slate-200 bg-opacity-40 self-center w-[70%] lowtwo3:w-[80%] lowtwo:ml-2 flex flex-col pl-3 pr-3 rounded-3xl pb-6 items-center
        justify-center mt-2">
            <Image className="rounded-[30%] self-center w-[300px] midtw:w-[230px] midfour:w-[170px]" src={CaiqueAnimation} alt="Caique (the developer of this page) animate art image"/>
                ...
                <h1 className="text-black font-semibold">Experiência: 7 meses</h1>
                ...
                <div className="flex mt-4">
                    <FaLinkedin size={25}/>: <Link href="https://www.linkedin.com/in/caique-dos-santos-a69425246/" target="_blank">
                        <p className="links-inform ml-2 text-blue-900 midtwo:text-[13px] midfour:text-[11px] midfour:font-bold lowone:text-[9px]">https://www.linkedin.com/in/caique-dos-santos-a69425246/</p></Link>
                </div><div className="flex mt-4">
                    <FaGithub size={25}/>: <Link href="https://github.com/Caiqu3wav" target="_blank">
                        <p className="links-inform ml-2 text-blue-900 midtwo:text-[13px] midfour:text-[11px] midfour:font-bold">https://github.com/Caiqu3wav</p></Link>
                </div>
                <div className="flex mt-4">
                ...
                midfour:text-[13px]" target='_blank' href=" https://wa.me/12997364432">(12) 997364432</a>
                </div>
            </div>
</div>
</div>
